...
export const getUser = async (ctx: RouterContext<'/users/:id', { id: string }>) => {
...
export const updateUser = async (ctx: RouterContext<'/users/:id', { id: string }>) => {
    const id = ctx.params.id
...
export const deleteUser = async (ctx: RouterContext<'/users/:id', { id: string }>) => {
    const id = ctx.params.id
